...
const projects = [
  ...
  },
  {
    name: 'Escape Room 60',
    description:
      'They wanted a more performant modern solution than their current WordPress site I did for them years ago. Kept header branding, but went with a Next.js refactor that included large content images for more interest. With Next.js baked-in image optimization, the site loads very fast and is now live.',

    links: [
      {
        url: 'https://www.escaperoom60.com/',
        label: 'Site',
      },
    ],
  ...
  },
  {
    ...
    description:
      'I made a basic Nextjs static page to share my Jesus Christ artwork. After research, I removed the nav and some sections that were killing the user flow. It all began with me explaining why I drew two Christ sketches a long time ago. Now, it includes digital art. Google "free Jesus Christ art"',
