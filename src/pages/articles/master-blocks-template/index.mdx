...
<Image src={masterBlocks} alt="Master Blocks" />
...
After the first round of landing pages were quickly churned out, I added round 2 features to the <a href="https://www.topwebwork.com/demo/master-blocks/aop-master-lp-blocks.html" target="samples">template</a>. I also created an <a href="https://www.topwebwork.com/demo/master-blocks/example-aop-lp.html" target="samples">example</a> to illustrate use for the designers. Here is a <a href="https://www.aop.com/lp/holiday-gift-guide" target="samples">page</a> that was wrapped in the cms header and footer.
