...
export const meta = {
  ...
  description:
    'I was told their busy season started 3 weeks ago, and they needed several landing pages - fast. Late nights may be required. WordPress, custom CMS, and standalone - multiple brands. I quickly built a Tailwind-inspired modular custom HTML template & demo that allowed for platform & variable overrides. Now landing pages can be set up before the job ticket is.',
}
