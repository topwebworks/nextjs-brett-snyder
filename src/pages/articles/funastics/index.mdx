...
<Image src={funasticsForms} alt="Funastics Forms" />
...
<Image src={funasticsPhotos} alt="Funastics Building" />
...
<Image src={funasticsWeb} alt="Funastics Website" />

This site was cool at the time. The website was Flash-based. The content was dynamic - animated images. People could sign up and pay bills online; that blew people away. The site also included any forms, and info they may want. They could play the music we played in the gym, at home. Even had hidden arcade games the parents played more than the students. With only a $50/mo PPC budget, I got Funastics.com ranked above my local competitors in just 4 months...even the franchises. This was before Google prioritized content over meta details.

## Print

<Image src={funasticsPrint} alt="Funastics Print" />
